...
# Allow runtime override of tokens_to_generate via env var.
# Applies to BOTH data prepare and prediction (both import this module).
import os as _os
_OVERRIDE = _os.environ.get("MAX_NEW_TOKENS_OVERRIDE")
if _OVERRIDE:
    _OVERRIDE = int(_OVERRIDE)
    for _k in TASKS:
        TASKS[_k]["tokens_to_generate"] = _OVERRIDE
