...
class LlamaDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        torch.cuda.nvtx.range_push ("residual")
    ...
    def forward(
        ...
        **flash_attn_kwargs: Unpack[FlashAttentionKwargs],
        ...
        for decoder_layer in self.layers[: self.config.num_hidden_layers]:
            layer_inputs.append(hidden_states.detach().cpu())
            ...
            if self.gradient_checkpointing and self.training:
                ...
                torch.cuda.nvtx.range_push ("decoder layer" + str (decoder_layer.layer_idx))
        ...
        #     v1 = layer_inputs[i].flatten()
        #     v2 = layer_inputs[i+1].flatten()
        #     sim = F.cosine_similarity(v1, v2, dim=0).item()
        #     print(f"[LlamaModel] layer{i} and layer{i+1} similarity score = {sim:.4f}")
