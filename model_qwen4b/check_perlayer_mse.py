...
SC kernel saw, compute the F.linear reference and record MSE / max|Δ|. Same
structure as scmp_llm/check_perlayer_mse.py but for Qwen3-4B via qwen3_sc.
"""
import os
import statistics
...
from qwen3_sc import make_qwen3_sc, SCLinear
